...
$Sc$ =$(OBS,\ ACS)$\\
$OBS$ = $\{ (\neg run\_Max, 0), ( \neg bark\_Max, 0),  ( run\_Max, 3),  (\neg run\_Max, 5),  (bark\_Max, 6),   ( \neg bark\_Max, 7),\\ ( run\_Max, 9),  (\neg run\_Max, 11)  \}$\\
...
\textit{Sc} =$(OBS,\ ACS)$\\
\textit{OBS} =  $\{ (\neg on\_computer, 0), (connect\_power\_computer, 0), (on\_computer, 4), (\neg on\_computer, 5),\\  (\neg connect\_power\_computer, 5)\}$\\
