...
Ten przykład pokazuje przypadek kwarendy, która pyta, czy dana akcja jest wykonywana w pewnym czasie.
...
\begin{enumerate}
	\item \textbf{performing} $running\_Max$  \textbf{at} $TODO$ \textbf{when} \textit{Sc}
	\item \textbf{performing} $running\_Max$   \textbf{when} \textit{Sc}
	\item \textbf{performing}   \textbf{at} $TODO$ \textbf{when} \textit{Sc}
\end{enumerate}
