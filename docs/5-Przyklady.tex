...
\begin{enumerate}
	...
	\item  \textbf{performing at} 5  \textbf{when}  \textit{Sc2}
\end{enumerate}
...
\begin{enumerate}
	\item \texttt{TRUE},
	\item \texttt{TRUE},
	\item Nie można zrealizować scenariusza \textit{Sc2},
\end{enumerate}
...
$(goes\_Bill,2)$  \textbf{invokes} $(runs\_Max,2)$  \textbf{after} $1$\\
...
$(clicks\_button\_on,1)$  \textbf{invokes} $(switches\_on\_computer,2)$  \textbf{after} $1$\\
