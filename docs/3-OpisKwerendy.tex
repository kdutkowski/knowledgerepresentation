...
\item[Q3.] Czy w chwili $t$ realizacji scenariusza wykonywana jest akcja $A$?
	\begin{itemize}
		...
		Oznacza, że zawsze w jednostce czasu $t$ realizacji scenariusza $Sc$ zachodzi akcja $A$.
		\item $performing\ A\ when\ Sc$\\
		Oznacza, że w dowolnej jednostce czasu realizacji scenariusza $Sc$ zachodzi akcja $A$.
		\item $performing\ at\ t\ when\ Sc$\\
		Oznacza, że zawsze w jednostce czasu $t$ realizacji scenariusza $Sc$ zachodzi pewna akcja.
	\end{itemize}
