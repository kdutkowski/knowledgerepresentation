namespace KnowledgeRepresentationReasoning.Queries
{
    ...
    public class AccesibleConditionQuery : Query
    {
        ...
        public AccesibleConditionQuery(QuestionType questionType, string condition, ScenarioDescription scenario,int time)
            : base(QueryType.AccesibleCondition, questionType)
        {
            ...
            CondAtTimeQuery = new ConditionAtTimeQuery(QuestionType.Ever, _condition,time);
